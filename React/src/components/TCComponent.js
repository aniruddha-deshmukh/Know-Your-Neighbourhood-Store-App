...
class TCComponent extends Component {
  ...
  render() {
    ...
    return (
      <div class="p-4 bg-image text-white" style={mystyle}>
        <div
        ...
        >
          ...
          <p>
            ...
            use of Know Your Neighbourhood's Website, located at www.KnowYN.com.
          </p>

          <p>
            By accessing this website we assume you accept these terms and
            conditions. Do not continue to use Know Your Neighbourhood if you do
          ...
          <p>
            We employ the use of cookies. By accessing Know Your Neighbourhood,
            you agreed to use cookies in agreement with the Know Your
            Neighbourhood's Privacy Policy.{" "}
          </p>
          ...
          <p>
            Unless otherwise stated, Know Your Neighbourhood and/or its
            licensors own the intellectual property rights for all material on
            Know Your Neighbourhood. All intellectual property rights are
            reserved. You may access this from Know Your Neighbourhood for your
          ...
          <ul>
            ...
            <li>
              Sell, rent or sub-license material from Know Your Neighbourhood
            </li>
            <li>
              Reproduce, duplicate or copy material from Know Your Neighbourhood
            </li>
          ...
          <p>
            ...
            <a>
              https://www.termsandconditionsgenerator.com Terms And Conditions
              Generator
            </a>
            .
          </p>
          ...
          <p>
            ...
            Know Your Neighbourhood does not filter, edit, publish or review
            Comments prior to their presence on the website. Comments do not
            reflect the views and opinions of Know Your Neighbourhood,its agents
            ...
            applicable laws, Know Your Neighbourhood shall not be liable for the
          ...
          <p>
            Know Your Neighbourhood reserves the right to monitor all Comments
          ...
          <p>
            You hereby grant Know Your Neighbourhood a non-exclusive license to
          ...
          <p>
            ...
            visibility of the hyperlink compensates the absence of Know Your
            Neighbourhood; and (d) the link is in the context of general
          ...
          <p>
            ...
            sending an e-mail to Know Your Neighbourhood. Please include your
          ...
          <p>
            No use of Know Your Neighbourhood's logo or other artwork will be
