package com.aades.KYN.controller;
...
import com.aades.KYN.service.StoreService;
...
public class StoreController {
	...
	@RequestMapping(value = "/api/store/{Storeid}", produces = "application/json", method = RequestMethod.PUT)
