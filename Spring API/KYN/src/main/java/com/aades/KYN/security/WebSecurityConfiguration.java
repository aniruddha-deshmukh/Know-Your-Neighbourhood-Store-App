package com.aades.KYN.security;
...
public class WebSecurityConfiguration extends WebSecurityConfigurerAdapter {
	...
	private static final String[] AUTH_WHITELIST = { "/users/api", "/messages/*", "/configuration/ui",
	...
	protected void configure(HttpSecurity httpSecurity) throws Exception {
		...
		httpSecurity.cors().and().csrf().disable().authorizeRequests().antMatchers(AUTH_WHITELIST).permitAll()
				.antMatchers(HttpMethod.POST, "/users/api").permitAll().anyRequest().authenticated().and()
